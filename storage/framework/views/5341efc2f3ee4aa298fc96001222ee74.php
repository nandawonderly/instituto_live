...
<body>
    ...
    <header class="top-header">
        ...
        <div class="user-profile">
            <img src="<?php echo e(asset('imagens/user.webp')); ?>" alt="Foto Aluno" class="profile-img">
            <span class="user-name"><?php echo e($primeiro_nome); ?></span>
        </div>
    </header>
    ...
    <div class="main-container">
        ...
        <main class="content-area">
            <div class="greeting">
                <h2>Olá, <?php echo e($primeiro_nome); ?>!</h2>
...
</html><?php /**PATH C:\Users\ferna\Documents\site cintia curso\instituto_live\resources\views/painel_aluno.blade.php ENDPATH**/ ?>